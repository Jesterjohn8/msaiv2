...
import com.example.msaiv3.ui.math8_quarter3.W1;
import com.example.msaiv3.ui.math8_quarter3.W2;
import com.example.msaiv3.ui.math8_quarter3.W3;
import com.example.msaiv3.ui.math8_quarter3.W4;
import com.example.msaiv3.ui.math8_quarter3.W5;
import com.example.msaiv3.ui.math8_quarter3.W6;
import com.example.msaiv3.ui.math8_quarter3.W7;


public class Math8_q3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_math8_q3);

        ImageButton Week01 = findViewById(com.example.msaiv3.R.id.Week1);
        Week01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math8_q3.this, W1.class);
        ...
        Week02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math8_q3.this, W2.class);
                startActivity(intent);
            }
        });
        ...
        Week03.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math8_q3.this, W3.class);
                startActivity(intent);
        ...
        Week04.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math8_q3.this, W4.class);
                startActivity(intent);
        ...
        Week05.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math8_q3.this, W5.class);
                startActivity(intent);
        ...
        Week06.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math8_q3.this, W6.class);
                startActivity(intent);
        ...
        Week07.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math8_q3.this, W7.class);
                startActivity(intent);
