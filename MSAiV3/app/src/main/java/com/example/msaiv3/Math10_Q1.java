...
import com.example.msaiv3.ui.math10_quarter1.W1;
import com.example.msaiv3.ui.math10_quarter1.W2;
import com.example.msaiv3.ui.math10_quarter1.W3;
import com.example.msaiv3.ui.math10_quarter1.W4;
import com.example.msaiv3.ui.math10_quarter1.W5;
import com.example.msaiv3.ui.math10_quarter1.W6;
import com.example.msaiv3.ui.math10_quarter1.W7;
import com.example.msaiv3.ui.math10_quarter1.W8;


public class Math10_Q1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_math10_q1);
        ImageButton Week01 = findViewById(com.example.msaiv3.R.id.Week1);
        Week01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math10_Q1.this, W1.class);
        ...
        Week02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math10_Q1.this, W2.class);
                startActivity(intent);
            }
        });
        ...
        Week03.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math10_Q1.this, W3.class);
                startActivity(intent);
        ...
        Week04.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math10_Q1.this, W4.class);
                startActivity(intent);
        ...
        Week05.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math10_Q1.this, W5.class);
                startActivity(intent);
        ...
        Week06.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math10_Q1.this, W6.class);
                startActivity(intent);
        ...
        Week07.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math10_Q1.this, W7.class);
                startActivity(intent);
        ...
        Week08.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Math10_Q1.this, W8.class);
                startActivity(intent);
