...
import com.example.msaiv3.ui.math_quarter1.W1;
import com.example.msaiv3.ui.math_quarter1.W2;
import com.example.msaiv3.ui.math_quarter1.W3;
import com.example.msaiv3.ui.math_quarter1.W4;
import com.example.msaiv3.ui.math_quarter1.W5;
import com.example.msaiv3.ui.math_quarter1.W6;
import com.example.msaiv3.ui.math_quarter1.W7;
import com.example.msaiv3.ui.math_quarter1.W8;
import com.example.msaiv3.ui.math_quarter1.W9;

public class MathQ1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_q1);
                ...
                Week01.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(MathQ1.this, W1.class);
                ...
                Week02.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(MathQ1.this, W2.class);
                        startActivity(intent);
                    }
                });
                ...
                Week03.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(MathQ1.this, W3.class);
                        startActivity(intent);
        ...
        Week04.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MathQ1.this, W4.class);
                startActivity(intent);
        ...
        Week05.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MathQ1.this, W5.class);
                startActivity(intent);
        ...
        Week06.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MathQ1.this, W6.class);
                startActivity(intent);
        ...
        Week07.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MathQ1.this, W7.class);
                startActivity(intent);
        ...
        Week08.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MathQ1.this, W8.class);
                startActivity(intent);
        ...
        Week09.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MathQ1.this, W9.class);
                startActivity(intent);

            }
        });

        Button btnStartQuiz = findViewById(R.id.W1Quiz);

        btnStartQuiz.setOnClickListener(v -> {
            Intent intent = new Intent(MathQ1.this, Math7_Quiz_Q1.class);
            startActivity(intent);
        });
